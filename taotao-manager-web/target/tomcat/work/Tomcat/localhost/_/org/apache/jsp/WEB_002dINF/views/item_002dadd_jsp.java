 ...
 * Generated at: 2017-08-26 13:05:53 UTC
...
public final class item_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//获取id为itemAddFrom的元素，就是 提交表单\r\n");
      out.write("\t\t//查找属性有name=price的元素，就是需要提交到后台的input标签\r\n");
      out.write("\t\t//eval的方法就是做字符串\"1\"+\"2\"=\"3\"，这个方法执行成功后的效果是，把用户数据的价格乘以一百\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#itemAddForm [name=price]\").val(eval($(\"#itemAddForm [name=priceView]\").val()) * 100);\r\n");
      out.write("\t\t//把富文本编辑器区域的html代码，同步到多行文本中，向后台提交的是多行文本\r\n");
